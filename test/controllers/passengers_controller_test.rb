...
class PassengersControllerTest < ActionController::TestCase
  ...
  test "should create passenger" do
    assert_difference('Passenger.count') do
      post :create, passenger: { department: @passenger.department, email: @passenger.email, interests: @passenger.interests, name: @passenger.name, university: @passenger.university, year: @passenger.year }
    end
  ...
  test "should update passenger" do
    patch :update, id: @passenger, passenger: { department: @passenger.department, email: @passenger.email, interests: @passenger.interests, name: @passenger.name, university: @passenger.university, year: @passenger.year }
    assert_redirected_to passenger_path(assigns(:passenger))
  end
